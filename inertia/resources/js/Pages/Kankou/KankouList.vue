...
<template>
  <Head title="KankouList"></Head>
  <App></App>
  <nav>
    <ol class="breadcrumb">
      <li class="list"><Link class="after_add"  :href="route('index')">Home</Link></li>
      >
      <li class="list">観光地所一覧</li>
    </ol>
  </nav>
  <div id="card">
    <div class="container-plan">
      <div class="flex flex-wrap -mb-10">
        <div class="card-ele" v-for="post in posts" :key="post.posts_id">
          <Link class="underline" :href="route('kankouDetail',post.posts_id)">
            ...
            <div class="text-body bg-white p-5">
              ...
              <p class="text-xl text-gray-800 mb-5">#{{ post.prefectures.prefectures_name }}</p>
